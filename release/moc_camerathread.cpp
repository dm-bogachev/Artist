...
QT_MOC_LITERAL(3, 20, 8), // "cv::Mat*"
QT_MOC_LITERAL(4, 29, 5) // "Error"

    },
    "CameraThread\0Ready\0\0cv::Mat*\0Error"
};
...
void CameraThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Ready((*reinterpret_cast< cv::Mat*(*)>(_a[1])),(*reinterpret_cast< cv::Mat*(*)>(_a[2]))); break;
...
// SIGNAL 0
void CameraThread::Ready(cv::Mat * _t1, cv::Mat * _t2)
{
